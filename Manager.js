...
(function() {
     ...
     */
        ...
        function Manager(conf) {
            ...
            self._generateWorkQueue = function(workerRange, workTimeRange) {
                var self = this;
            ...
            self.bind("finishOneRound", function() {
                ...
                var workeTimeRange = self.conf.workeTimeRange || [1, 3];
            ...
            self.Stratergy = {
                ...
                random: function() {
                    ...
                    //how many workers per round
                    var workerRange = self.conf.workerRange || [2, 4];
                    //how many times woker can run per round
                    var workeTimeRange = self.conf.workeTimeRange || [1, 3];
                    self._generateWorkQueue(workerRange, workeTimeRange);
